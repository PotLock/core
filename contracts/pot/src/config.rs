...
impl Contract {
    pub fn get_config(&self) -> PotConfig {
        PotConfig {
            ...
            min_matching_pool_donation_amount: self.min_matching_pool_donation_amount.into(),
            ...
            matching_pool_balance: self.matching_pool_balance.into(),
            ...
            remaining_funds_redistribution_recipient: self
                .remaining_funds_redistribution_recipient
                .get(),
            remaining_funds_redistributed_at_ms: self.remaining_funds_redistributed_at_ms.get(),
